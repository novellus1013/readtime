    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Row(children: [
            Image.asset(
              'assets/images/read_time_logo.png',
...
//   const _DailyGoal({
//     super.key,
//     required this.todaysSessionTime,
//     required this.goalSessionTime,
//   });

//   final int todaysSessionTime;
//   final int goalSessionTime;
...
//                 Gaps.v24,
//                 Text(
//                   '$todaysSessionTime / $goalSessionTime 분',
//                   style: TextStyle(
//                     color: lightWhite,
//                     fontSize: Sizes.size16,
//                     fontWeight: FontWeight.w500,
